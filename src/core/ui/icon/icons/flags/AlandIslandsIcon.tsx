...
const AlandIslandsIcon = ({
  ...
  <Svg width={size} height={size} viewBox="0 0 48 48" fill="none" {...props}>
    <G clipPath="url(#a)">
      ...
      />
      <G fill="#0052B4">
        <Path d="M.827 30.26A24.02 24.02 0 0 0 9.39 43.042v-12.78H.827ZM21.913 47.909c.688.059 1.384.091 2.087.091 11.089 0 20.42-7.52 23.173-17.74h-25.26V47.91ZM47.173 17.74C44.42 7.52 35.09 0 24 0c-.703 0-1.399.032-2.087.091V17.74h25.26ZM9.391 4.959a24.02 24.02 0 0 0-8.564 12.78H9.39V4.96Z" />
      </G>
      <Path
...
export default AlandIslandsIcon;
